# Policy on Team Member Removal

The following policy applies to the removal of members of the NeoForged Team by a recorded vote of the members.
...
8. The "initiating Member" is the Member who made the removal call.
...
1. A Member may initiate the removal of another Member by calling for a vote in a private space.
    ...
    1.1. The removal call must include the name of the initiating Member, the Member under removal, a reason (or multiple reasons) for the removal, and either the specific Team being removed or the Neo Team. An example, though it is not required to conform to this exactly: _"I call for the removal of (name) from the (team name) for the following reasons: (reasons)"_.

    1.2. The removal call must be in a space accessible and visible to all Members of the Neo Team. It may be, but is suggested not to be, in a public space accessible to the general community, but it must not be writable by the general community. It should include a mention or notification to the Members of the Neo Team.
    ...
    1.4. A removal call may not be made while there are existing removal proceedings underway.
...
2. Another Member, different from either the initiating Member or the Member under removal, must second the removal call by stating the same within the same space as the removal call.
    ...
    2.1. The seconding of the removal call may be made without any attached reason or discussion. An example, though it is not required to conform to this exactly: _"I second the call for removal of (name)."_
...
2. A discussion period of 7 days shall be held, during which Members (including the Member under removal) may discuss the merits of the removal proceedings.
    ...
    2.2. The discussion period may not be extended or reduced except with the unanimous consent of all Members of the Neo Team as expressed in a vote of 24 hours duration. An extension must only be up to 2 weeks beyond the original end of the discussion period. For the vote to succeed, no Member must have casted a vote in the negative. For a vote to reduce the time, at least half of all Members of the Neo Team must have voted for it to succeed. Only one vote to extend the time and one vote to reduce the time shall be allowed, and only one vote shall be ongoing at any given time.
...
1. Once the discussion period has ended, a vote shall be held for 7 days, which shall be open to all Members of the Neo Team _except_ for the Member under removal.
    ...
    1.4. During the vote, Members may continue to discuss the removal proceedings.
